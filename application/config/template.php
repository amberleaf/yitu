...
|
*/
$config['OCU_site_name'] = array('title' => '医图在线');
...
|
*/
$config['OCU_default_layout'] = "layout";
...
|
*/
$config['OCU_cache_view_expires'] = 60;
...
*/
$config['OCU_cache_layout_expires'] = 120;
