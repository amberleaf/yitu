		...
		<link rel="stylesheet" href="<?php echo PUBLICADMIN?>assets/css/jquery-ui-1.10.3.custom.min.css" />
		<link rel="stylesheet" href="<?php echo PUBLICADMIN?>assets/css/chosen.css" />
		<link rel="stylesheet" href="<?php echo PUBLICADMIN?>assets/css/datepicker.css" />
		<link rel="stylesheet" href="<?php echo PUBLICADMIN?>assets/css/bootstrap-timepicker.css" />
		<link rel="stylesheet" href="<?php echo PUBLICADMIN?>assets/css/daterangepicker.css" />
		<link rel="stylesheet" href="<?php echo PUBLICADMIN?>assets/css/colorpicker.css" />
		...
		<script src="<?php echo PUBLICADMIN?>assets/js/jquery-ui-1.10.3.custom.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/jquery.ui.touch-punch.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/chosen.jquery.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/fuelux/fuelux.spinner.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/date-time/bootstrap-datepicker.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/date-time/bootstrap-timepicker.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/date-time/moment.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/date-time/daterangepicker.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/bootstrap-colorpicker.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/jquery.knob.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/jquery.autosize.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/jquery.inputlimiter.1.3.1.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/jquery.maskedinput.min.js"></script>
		<script src="<?php echo PUBLICADMIN?>assets/js/bootstrap-tag.min.js"></script>
