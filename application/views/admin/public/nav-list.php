<ul class="nav nav-list">
	<li<?php echo $active_controller == 'main' ? ' class="active"' : ''?>>
	...
	<li<?php echo $active_controller == 'hospital' ? ' class="active open"' : ''?>>
		...
		<ul class="submenu">
			...
			<li<?php echo  $active_controller == 'hospital' && $active_method == 'lists' ? ' class="active"' : ''?>>
			...
			<li<?php echo  $active_controller == 'hospital' && $active_method == 'edit_hospital' ? ' class="active"' : ''?>>
			...
			<li<?php echo  $active_controller == 'hospital' && $active_method == 'dept_lists' ? ' class="active"' : ''?>>
			...
			<li<?php echo  $active_controller == 'hospital' && $active_method == 'edit_dept' ? ' class="active"' : ''?>>
	...
	<li<?php echo $active_controller == 'docter' ? ' class="active open"' : ''?>>
		<a href="" class="dropdown-toggle">
		...
		<ul class="submenu">
			...
			<li<?php echo $active_controller == 'docter' && $active_method == 'lists' ? ' class="active"' : ''?>>
			...
			<li<?php echo $active_controller == 'docter' && $active_method == 'edit' ? ' class="active"' : ''?>>
	...
	<li<?php echo $active_controller == 'role' ? ' class="active open"' : ''?>>
		<a href="" class="dropdown-toggle">
			<i class="icon-key"></i>
		...
		<ul class="submenu">
			...
			<li<?php echo $active_method == 'role_lists' ? ' class="active"' : ''?>>
			...
			<li<?php echo $active_method == 'add' ? ' class="active"' : ''?>>
			...
			<li<?php echo $active_controller == 'auth' && $active_method == 'lists' ? ' class="active"' : ''?>>
			...
			<li<?php echo  $active_controller == 'auth' && $active_method == 'register' ? ' class="active"' : ''?>>
			...
			<li<?php echo $active_method == 'permission' ? ' class="active"' : ''?>>
	...
	<li<?php echo $active_controller == 'alog' ? ' class="active open"' : ''?>>
		<a href="" class="dropdown-toggle">
		...
		<ul class="submenu">
			...
			<li<?php echo $active_method == 'index' ? ' class="active"' : ''?>>
